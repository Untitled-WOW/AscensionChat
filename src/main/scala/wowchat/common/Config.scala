...
case class DiscordConfig(token: String, enableDotCommands: Boolean, dotCommandsWhitelist: Set[String], bannedInviteList: Set[String], enableInviteChannels: Set[String], enableKickChannels: Set[String], enablePromoteChannels: Set[String], enableDemoteChannels: Set[String], enableSetGmotdChannels: Set[String], enableWhoGmotdChannels: Set[String], enableTagFailedNotifications: Boolean, specLengthOption: Int)
...
case class WowChannelConfig(
  id: Option[Int],
  tp: Byte,
  channel: Option[String] = None,
  format: String,
  filters: Option[FiltersConfig],
  includePatterns: Seq[String] = Seq(),   // NEW
  excludePatterns: Seq[String] = Seq()    // NEW
)
      ...
      .map(channel => {
        ...
        ChannelConfig(
          ...
          WowChannelConfig(
            ...
            getOpt[Seq[String]](channel, "wow.include_patterns").getOrElse(Seq()),  // NEW
            getOpt[Seq[String]](channel, "wow.exclude_patterns").getOrElse(Seq())   // NEW
          ),
